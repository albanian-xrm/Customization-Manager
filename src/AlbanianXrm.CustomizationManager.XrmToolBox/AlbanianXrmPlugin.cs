...
namespace AlbanianXrm.CustomizationManager
{
    [Export(typeof(IXrmToolBoxPlugin)),
     ExportMetadata("Name", "Albanian Customization Manager"),
     ExportMetadata("Company", "Betim Beja, AlbanianXrm"),
     ExportMetadata("Description", "This tool helps find and organize unmanaged customizations"),
    ...
    public class AlbanianXrmPlugin : PluginBase
    {
        ...
        /// For example, a folder named AlbanianXrm.SolutionPackager 
        /// </summary>
        ...
        private Assembly AssemblyResolveEventHandler(object sender, ResolveEventArgs args)
        {
            ...
            {
                return Assembly.LoadFrom(assmbPath);
            }
            else
            {
